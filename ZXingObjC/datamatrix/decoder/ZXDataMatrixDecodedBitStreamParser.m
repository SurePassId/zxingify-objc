  ...
  do {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      case 0:
        if (cValue < 3) {
          shift = cValue + 1;
        } else if (cValue < sizeof(C40_BASIC_SET_CHARS) / sizeof(const unichar)) {
      ...
      case 1:
        ...
        break;
      case 2:
        if (cValue < sizeof(C40_SHIFT2_SET_CHARS) / sizeof(const unichar)) {
  ...
  do {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      case 0:
        if (cValue < 3) {
          shift = cValue + 1;
        } else if (cValue < sizeof(TEXT_BASIC_SET_CHARS) / sizeof(const unichar)) {
      ...
      case 2:
        ...
        break;
      case 3:
        if (cValue < sizeof(TEXT_SHIFT3_SET_CHARS) / sizeof(const unichar)) {
